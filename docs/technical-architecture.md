...
第 3 节作为整体设计索引，各主题的详细设计分别维护。当前 §3.1 已依据[界面展示与交互开发文档](ui-interaction-design.md)完成界面验收版；其余主题后续继续补充数据字段、接口约定、计算公式、策略参数、任务恢复机制和验收用例。界面文档中依赖这些主题的业务规则，在对应设计确认后同步校对，并进行真实接口联调验收。
